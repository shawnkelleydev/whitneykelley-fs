  ...
  return (
    <div className="Bio">
      <p>
        ...
        <a
          href="https://denverphilharmonic.org/about/our-orchestra/"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <p>
        ...
        masterclasses, online videos, and publications in the National Flute
        Association Pedagogy Anthology Vol. 2, American Suzuki Journal, Colorado
        Flutist, and Flute Examiner. While maintaining a thriving Suzuki studio
      ...
      <p>
        ...
        , and training with Suzuki flute founder, Toshio Takahashi.
      </p>
    </div>
  );
};
